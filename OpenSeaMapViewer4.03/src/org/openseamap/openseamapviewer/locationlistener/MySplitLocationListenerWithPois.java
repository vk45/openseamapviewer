...
public class MySplitLocationListenerWithPois implements LocationListener{
	private final SplitOpenSeaMapWithAerialOverlayAndPoisViewer splitOpenseamapviewer;
	private boolean centerAtFirstFix;

	public MySplitLocationListenerWithPois(SplitOpenSeaMapWithAerialOverlayAndPoisViewer openseamapMapViewer) {
