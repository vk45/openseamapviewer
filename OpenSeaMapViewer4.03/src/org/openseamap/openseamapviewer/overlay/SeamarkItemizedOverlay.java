...
public class SeamarkItemizedOverlay extends ArrayItemizedOverlay {
	
	private static final String TAG="SeamarkItemizedOverlay";
	private final OpenSeamapViewerWithPois mContext;
	 ...
	 */
	public SeamarkItemizedOverlay(Drawable defaultMarker, OpenSeamapViewerWithPois context, boolean fillDirectionalSector) {
		super(defaultMarker);
