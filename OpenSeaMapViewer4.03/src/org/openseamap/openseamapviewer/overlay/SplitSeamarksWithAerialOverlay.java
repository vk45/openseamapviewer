...
public class SplitSeamarksWithAerialOverlay extends Overlay {
    ...
    private final SplitOpenSeaMapWithAerialOverlayViewer mContext;
	 ...
	 */
    public SplitSeamarksWithAerialOverlay(Drawable defaultMarker, SplitOpenSeaMapWithAerialOverlayViewer context,SeamarkOsm seamarkOsm , boolean fillDirectionalSector) {
		super();
	...
	private void drawSeamarks(Canvas canvas, Point drawPosition, Projection projection, byte drawZoomLevel){
		...
		for (int index = 0; index < count; index++ ) {
			...
			SeamarkDrawable aSeamarkDrawable = new SeamarkDrawable(seamarkNode,drawZoomLevel);
