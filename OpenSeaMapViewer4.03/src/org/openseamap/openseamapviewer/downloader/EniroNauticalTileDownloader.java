...
public class EniroNauticalTileDownloader extends TileDownloader {
	...
	private String mCacheDirPathStr =  stdDir +"/Cachedata/EniroNautical";
	// Timeout
	 ...
	 */
	public EniroNauticalTileDownloader(Context context) {
		mContext = context;
	...
	private void writeTileToCache (String cacheFilePathName, Bitmap bitmap){
		...
		try {
		    ...
		    bitmap.compress(CompressFormat.JPEG, 50, os); // PNG: 50 is ignored
	...
	public boolean executeJob(MapGeneratorJob mapGeneratorJob, Bitmap bitmap) {
		...
		try {
			...
			String filename = "EniroNauticalTile_" + tile.zoomLevel + "_" + tile.tileX+"_"+tile.tileY;
