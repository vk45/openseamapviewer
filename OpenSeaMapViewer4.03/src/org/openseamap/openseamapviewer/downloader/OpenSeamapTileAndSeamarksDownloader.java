...
public class OpenSeamapTileAndSeamarksDownloader extends TileDownloader {
	...
	// 13_06_11 see the new info on http://wiki.openseamap.org/wiki/OpenSeaMap-dev:Server
	// seamarks: http://t1.openseamap.org/seamark/%7Bz%7D/%7Bx%7D/%7By%7D.png
	// base layer: http://t2.openseamap.org/tiles/base/%7Bz%7D/%7Bx%7D/%7By%7D.png
    ...
    private String mCacheDirPathStr =  stdDir +"/Cachedata/OpenSeaMap";
	/**
	 * Constructs a new OpenSeamapTilesAndSeamarksTileDownloader.
	 */
	public  OpenSeamapTileAndSeamarksDownloader(Context context) {
		super();
		mContext = context;
	...
	public String getTilePath(Tile tile) {
		...
		// 13_06_11 see the new info on http://wiki.openseamap.org/wiki/OpenSeaMap-dev:Server
		// seamarks  : http://t1.openseamap.org/seamark/{z]/{x}/{y}.png
		// base layer: http://t2.openseamap.org/tiles/base/{z}/{x}/{y}.png
