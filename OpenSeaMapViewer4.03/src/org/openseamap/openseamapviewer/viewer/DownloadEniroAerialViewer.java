...
public class DownloadEniroAerialViewer extends MapActivity {
	
	private static final String TAG = "DownloadEniroAerialViewer";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MapGenerator mapGenerator = aEniroAerialDownLoader;
	...
	private Runnable centerPointRefresh = new Runnable() {
		public void run() {
			...
			double lat = geoPoint.getLatitude();
			double lon = geoPoint.getLongitude();
			int LAT = geoPoint.latitudeE6;
			int LON = geoPoint.longitudeE6;
			String aMsg = "Mapcenter "  + "LAT: " + lat + " LON: " + lon + " Zoom " + zoom ;
			//aMsg = aMsg + "\nMapcenter "  + "LAT: " + LAT + " LON: " + LON + " Zoom " + zoom ;
